      ...
      <div className="article-page">
        <div className="container">
          <div className="article-page__not-found">
            ...
            <Link href={`/categories/${category}`} className="article-page__not-found-link">
              ← Back to {category}
            </Link>
          </div>
        </div>
    ...
    <div className="article-page">
      ...
      <div className="container">
        ...
        <nav className="article-page__breadcrumb" aria-label="Breadcrumb">
          <Link href="/categories" className="article-page__breadcrumb-link">
            Categories
          </Link>
          <span className="article-page__breadcrumb-sep" aria-hidden="true">/</span>
          <Link href={`/categories/${category}`} className="article-page__breadcrumb-link">
        ...
        <footer className="article-page__footer">
          <Link href={`/categories/${category}`} className="article-page__back">
